"""membership_inference_attack URL Configuration
...
from membership_inference_attack import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Membership_Inference_Attack/$', remoteuser.Predict_Membership_Inference_Attack, name="Predict_Membership_Inference_Attack"),
    ...
    url(r'^View_Membership_Inference_Attack_Prediction_Ratio/$', serviceprovider.View_Membership_Inference_Attack_Prediction_Ratio,name="View_Membership_Inference_Attack_Prediction_Ratio"),
    ...
    url(r'^View_Membership_Inference_Attack_Prediction/$', serviceprovider.View_Membership_Inference_Attack_Prediction, name="View_Membership_Inference_Attack_Prediction"),
